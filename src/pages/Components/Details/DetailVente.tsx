...
const DetailVente:FunctionComponent<BtnProps> = ({data,open,setOpen}) => {
                        ...
                        <div className="flex min-h-full items-center justify-center px-4 py-8">
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-8xl text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        <div style={{color:"#ff8041"}} className="uppercase underline flex justify-center text-center">{ 'Détail vente'}</div>
                                    </div>
                                   ...
                                   <div className="mt-5 grid w-full grid-cols-12 panel p-0 border-0 overflow-hidden">
                                    <div className=" col-span-4 w-full panel">
                                       <ul className=" m-auto space-y-5 font-semibold text-white-dark">
                                                <li className="flex items-center gap-2">
                                                     <strong>Nombre de produit </strong> <span>{data?.qte}</span>
                                                     <hr/>
                                                </li>
                                                <li className="flex items-center gap-2">
                                                    <strong>Montant ht : </strong> <span>{(data?.montant_ht || 0) + ' Fcfa'}</span>
                                                     <hr/>

                                                </li>
                                                 <li className="flex items-center gap-2">
                                                    <strong>Remise total (%) : </strong> <span>{data?.remise_total}</span>
                                                     <hr/>

                                                </li>
                                                 <li className="flex items-center gap-2">
                                                    <strong>Montant avec remise : </strong> <span>{(data?.montant_avec_remise || 0) + ' Fcfa'}</span>
                                                     <hr/>
                                                
                                                </li>
                                                 <li className="flex items-center gap-2">
                                                    <strong>Montant ttc : </strong> <span>{(data?.montant_ttc || 0) + ' Fcfa'}</span>
                                                     <hr/>
                                    ...
                                    <div className="col-span-8 w-full table-responsive panel">
                                        <table className="table-striped table-hover">
                                            ...
                                            <tbody>
                                                {data?.vente_produits?.map((contact: any) => {
                                                            return (
                                                                <tr style={{backgroundColor:"#e0dfdc"}} key={contact.id}>
                                                                    ...
                                                                    <td>
                                                                        <div className="flex items-center w-max">
                                                                            <div>{contact?.remise}</div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div className="flex items-center w-max">
                                                                            <div>{contact?.prix_vente}</div>
                                                                        </div>
                                                                    </td>
                                                                       <td>
                                                                        <div className="flex items-center w-max">
