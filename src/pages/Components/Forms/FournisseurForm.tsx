...
const FournisseurForm:FunctionComponent<BtnProps> = ({open,data,loading,setOpen,handleValidate}) => {
                ...
                <div className="flex min-h-full items-center justify-center px-4 py-8">
                    ...
                    >
                        <Dialog.Panel style={{borderWidth:2,borderColor:"#ff8041"}} className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                            ...
                            <div style={{color:"#ff8041"}} className="uppercase underline">{params.id ? 'Editer Fournisseur' : 'Ajouter Fournisseur'}</div>
                            </div>
                            <div className="p-5">
                              <form>
                                 <div className="mb-5">
                                ...
                                <div className="mb-5">
                                    ...
                                    <input id="telephone" type="text" placeholder="Entrer le telephone" className="form-input" value={params.telephone} onChange={(e) => changeValue(e)} />
                                </div>
                                <div className="mb-5">
