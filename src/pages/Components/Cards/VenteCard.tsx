...
const VenteCard:FunctionComponent<BtnProps> = ({data,handleDelete,handleValidate}) => {
                    ...
                    <h6 className="font-semibold text-md dark:text-white-light">{params.designation}</h6>
                     <div className="md:flex md:flex-row sm:flex-col gap-2">
                        ...
                        <div className="mb-5">
                            ...
                            <input id="prix_vente" type="text" placeholder="Entrer le prix unitaire" className="form-input" value={params.prix_vente} onChange={(e) => changeValue(e)} />
                        </div>
                        <div className="mb-5">
